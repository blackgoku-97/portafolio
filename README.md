...
El proyecto es un portafolio web.
...
* Inicio:
  ...
  * El sistema debe permitir un saludo y una imagen amigable.

* Proyectos:

  * El sistema debe mostrar proyectos.

* Habilidades:

  * El sistema debe mostrar habilidades.
