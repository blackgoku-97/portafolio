    ...
    <div className="p-10 text-white">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-200">
          Desarrollador Java Junior apasionado por el desarrollo web backend.
      ...
      <section>
        ...
        <ul className="text-gray-200">
          <li>
            📧 <a href="mailto:rpe19971210@gmail.com" className="text-sky-400">rpe19971210@gmail.com</a>
          </li>
          <li>
            ⚔️ <a href="https://github.com/blackgoku-97" target="_blank" className="text-purple-400">github.com/blackgoku-97</a>
          </li>
          <li>
            🧙‍♂️ <a href="https://www.linkedin.com/in/ricardo-perez-a31474229" target="_blank" className="text-sky-400">linkedin.com/in/ricardo-perez</a>
          </li>
        </ul>
      </section>
    </div>
