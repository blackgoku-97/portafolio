...
export default function SkillsCard({ name, desc, icon }: SkillsCardProps) {
  return (
    <div className="bg-slate-900/70 border border-cyan-500/30 rounded-xl p-6 shadow-md hover:shadow-cyan-500/40 hover:scale-105 transition-transform duration-300">
